...
const IndexPage = ({ data }) => {
  ...
  const {
    ...
    about_section_copy,
    about_columns,
  } = data.allPrismicHome.edges[0].node.data
  ...
  const slickSettings = {
    ...
    appendDots: dots => {
      ...
      return <span className="p-home__testimonialSliderNumber el-small" />
    },
  }
    ...
    <Layout title={page_title.text} bodyClass="home">
      <section className="c-banner c-banner--home" style={{ backgroundImage: `url(${masthead_background_image.url})` }}>
        <div className="l-container">
          <div className="c-banner__content">
            ...
            <div className="l-content" dangerouslySetInnerHTML={{ __html: masthead_copy.html }} />
            <a href="/" className="el-btn el-btn--outline-white c-banner__cta">
              {cta_block[0].cta_copy.text}
            </a>
          </div>
        </div>
      </section>
      <section className="p-home__provideSolutions">
        <div className="l-container">
          <header className="p-home__provideSolutionsHeader">
            ...
            <a href="/" className="el-btn el-btn--outline-grey p-home__provideSolutionsCTA">
              {solutions_cta_copy.text}
            </a>
          </header>
          <div className="p-home__provideSolutionsGrid l-grid l-grid--3">
            {solutions_section_columns.map((col, index) => (
              <div className="l-grid__col" key={`solutions-col-${index + 1}`}>
                ...
                <h3 className="l-grid__heading el-h3 p-home__provideSolutionsSubheader">{col.column_heading.text}</h3>
        ...
        <div className="l-container">
          ...
          <div className="p-home__creativityContent">
            <div className="o-block">
              ...
              <div className="l-content" dangerouslySetInnerHTML={{ __html: author_section_copy.html }} />
      ...
      <section className="p-home__aboutAgency l-section">
        <div className="l-container">
          <div className="o-block">
            ...
            <div className="l-content" dangerouslySetInnerHTML={{ __html: about_section_copy.html }} />
          </div>
      ...
      <section className="p-home__testimonial l-section">
        <div className="l-container">
          <div className="p-home__testimonialContent">
            <Slider ref={slider => (testimonialSlider.current = slider)} {...slickSettings}>
              {testimonial_items.map((testimony, index) => (
                <div key={`testimonial_${index}`}>
                  <div className="p-home__testimonialContentWrap">
                    ...
                    <div
                      className="p-home__testimonialContentCopy l-content"
                      dangerouslySetInnerHTML={{ __html: testimony.testimonial_copy.html }}
                    />
                  </div>
                </div>
              ))}
            </Slider>
            <span className="p-home__testimonialSliderNumber el-small">{`${zeroPad(currentSlide + 1, 2)}/${zeroPad(
          ...
          <div className="p-home__testimonialImageWrap">
            ...
            <nav className="p-home__testimonialPagination">
              <button
                type="button"
                onClick={previous}
                className="p-home__testimonialBtn el-btn__arrow el-btn__arrow--left"
              >
                Prev
              </button>
              <button
                type="button"
                onClick={next}
                className="p-home__testimonialBtn el-btn__arrow el-btn__arrow--right"
              >
                Next
              </button>
            </nav>
      ...
      <section className="p-home__services l-section l-section--bottom">
        <div className="l-container">
          ...
          <div className="p-home__servicesList" dangerouslySetInnerHTML={{ __html: services_list.html }} />
        </div>
      </section>
    </Layout>
  )
